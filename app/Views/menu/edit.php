      ...
      <div class="card card-custom">
        <div class="card-header">
          <div class="card-title">
            ...
            <h3 class="card-label">Form Ubah Menu</h3>
          </div>
        </div>
        <div class="card-body">
          <?= $validation->listErrors(); ?>
          <form class="form" id="kt_form_2" action="menu-management/<?= $menu->id; ?>" method="POST" autocomplete="off">
            ...
            <div class="form-group row">
              <div class="col-md-6">
                <label>Menu</label>
                <input type="text" name="menu" class="form-control" placeholder="Nama menu" value="<?= (old('menu')) ? old('menu') : $menu->menu; ?>" />
              </div>
              <div class="col-md-6 mt-3 mt-md-0">
                <label>Icon </label>
                <input type="text" name="icon" class="form-control" placeholder="default: fa-th-large" value="<?= (old('icon')) ? old('icon') : $menu->icon; ?>" />
