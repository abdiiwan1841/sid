...
<div class="form-group row justify-content-center">
  <div class="col-md-6 col-lg-4 mt-3 d-flex justify-content-center">
    <div class="image-input image-input-outline mb-3" id="kt_image_1">
      <div class="image-input-wrapper" style="background-image: url(/img/dokumen-kependudukan/<?= $dokumen_kependudukan->fotokopi_ktp ?? 'default.jpg' ?>)"></div>
  ...
  <div class="col-md-6 col-lg-4 mt-3 d-flex justify-content-center">
    <div class="image-input image-input-outline mb-3" id="kt_image_1">
      <div class="image-input-wrapper" style="background-image: url(/img/dokumen-kependudukan/<?= $dokumen_kependudukan->fotokopi_ijazah ?? 'default.jpg' ?>)"></div>
