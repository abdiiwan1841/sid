    ...
    <div class="d-flex align-items-center mt-5">
      <div class="symbol symbol-100 mr-5">
        <?php if (in_groups('admin')) : ?>
          <div class="symbol-label" style="background-image:url('<?= base_url(); ?>/assets/media/users/1.svg')"></div>
        <?php elseif (in_groups('supervisor')) : ?>
          <div class="symbol-label" style="background-image:url('<?= base_url(); ?>/assets/media/users/2.svg')"></div>
        <?php else : ?>
          <div class="symbol-label" style="background-image:url('<?= base_url(); ?>/assets/media/users/user.svg')"></div>
        <?php endif; ?>
