      ...
      <ul class="menu-nav">
        <?php if (in_groups('admin')) : ?>
          ...
          foreach ($menu as $m) : ?>
            ...
            <li class="menu-item menu-item-submenu<?= (url_is($m->slug) || url_is($m->slug . '/*')) ? ' menu-item-active' : '' ?>" aria-haspopup="true" data-menu-toggle="hover">
              <a href="javascript:;" class="menu-link menu-toggle">
                <span class="svg-icon menu-icon">
                  <!--begin::Svg Icon | path:assets/media/svg/icons/Layout/Layout-4-blocks.svg-->
                  <i class="fa fa-fw text-dark-50 <?= esc($m->icon); ?>"></i>
                  <!--end::Svg Icon-->
                </span>
                <span class="menu-text"><?= esc($m->menu); ?></span>
              ...
              <div class="menu-submenu">
                ...
                <ul class="menu-subnav">
                  <?php
                  $submenu = $db->table('user_sub_menu')->select('*')->where(['menu_id' => $m->id, 'is_active' => 1])
                    ->get()->getResultObject();
                  foreach ($submenu as $sm) : ?>
                    ...
                    <li class="menu-item<?= (base_url($sm->url) == current_url()) ? ' menu-item-active' : '' ?>" aria-haspopup="true">
                      <a href="<?= esc($sm->url); ?>" class="menu-link">
                        ...
                        <span class="menu-text"><?= esc($sm->title); ?></span>
