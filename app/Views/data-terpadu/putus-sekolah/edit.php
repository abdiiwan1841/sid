    ...
    <div class="container">
      ...
      <div class="card card-custom">
        ...
        <div class="card-body">
          ...
          <form class="form" id="kt_form_2" action="<?= route_to('data_terpadu_putus_sekolah_update', $putus_sekolah->id); ?>" method="POST" autocomplete="off">
            <input type="hidden" name="_method" value="PUT">
            <input type="hidden" name="id" value="<?= $putus_sekolah->id; ?>">
            <?= csrf_field(); ?>
