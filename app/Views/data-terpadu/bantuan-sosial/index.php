        ...
        <div class="card-body">
          ...
          <table class="table table-bordered table-hover table-checkable" id="datatable">
            ...
            <tbody>
              <?php
              $no = 1;
              foreach ($bantuan_sosial as $data) : ?>
                <tr>
                  <td style="text-align: center;"><?= $no++; ?></td>
                  <td>
                    <div class="d-flex">
                      <a class="btn btn-sm btn-icon btn-clean" title="Ubah" href="<?= route_to('data_terpadu_bantuan_sosial_edit', $data->id); ?>">
                        <i class="far fa-edit fa-sm"></i>
                      </a>
                      <form action="<?= route_to('data_terpadu_bantuan_sosial_delete', $data->id); ?>" method="post" class="d-inline">
