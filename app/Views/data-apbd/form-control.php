<div class="form-group row">
  ...
  <div class="col-md-6 col-lg-4 mt-3 mt-md-0">
    ...
    <input name="retribusi_daerah" class="form-control" value="<?= old('retribusi_daerah') ?? $data->retribusi_daerah; ?>">
  </div>
  <div class="col-md-6 col-lg-4 mt-3 mt-lg-0">
    <label>Hasil pengelolaan kekayaan daerah yang dipisahkan</label>
    <input name="hasil_pengelolaan_kekayaan" class="form-control" value="<?= old('hasil_pengelolaan_kekayaan') ?? $data->hasil_pengelolaan_kekayaan; ?>">
  </div>
  ...
  <div class="col-md-6 col-lg-4 mt-3">
    ...
    <input name="dana_alokasi_umum" class="form-control" value="<?= old('dana_alokasi_umum') ?? $data->dana_alokasi_umum; ?>">
  </div>
  <div class="col-md-6 col-lg-4 mt-3">
  ...
  <div class="col-md-6 col-lg-4 mt-3">
    <label>Hibah</label>
    <input name="hibah" class="form-control" value="<?= old('hibah') ?? $data->hibah; ?>">
  </div>
  <div class="col-md-6 col-lg-4 mt-3">
    <label>Dana darurat</label>
    <input name="dana_darurat" class="form-control" value="<?= old('dana_darurat') ?? $data->dana_darurat; ?>">
  </div>
  <div class="col-md-6 col-lg-4 mt-3">
    <label>Dana bagi hasil pajak dari Propinsi dan Pemda lainnya</label>
    <input name="dana_hasil_pajak_dari_provinsi" class="form-control" value="<?= old('dana_hasil_pajak_dari_provinsi') ?? $data->dana_hasil_pajak_dari_provinsi; ?>">
  </div>
  <div class="col-md-6 col-lg-4 mt-3">
    <label>Dana penyesuaian dan otonomi khusus</label>
    <input name="dana_penyesuaian" class="form-control" value="<?= old('dana_penyesuaian') ?? $data->dana_penyesuaian; ?>">
  </div>
  <div class="col-md-6 col-lg-4 mt-3">
    <label>Bantuan keuangan dari Propinsi atau Pemda lainnya</label>
    <input name="bantuan_keuangan" class="form-control" value="<?= old('bantuan_keuangan') ?? $data->bantuan_keuangan; ?>">
  </div>
  <div class="col-md-6 col-lg-4 mt-3">
    <label>Lain-lain</label>
    <input name="lain_lain" class="form-control" value="<?= old('lain_lain') ?? $data->lain_lain; ?>">
  </div>
</div>