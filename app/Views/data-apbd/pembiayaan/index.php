      ...
      <div class="card card-custom">
        <div class="card-header">
          ...
          <div class="card-toolbar">
            ...
            <!--end::Dropdown-->
            <!--begin::Button-->
            <a href="<?= route_to('data_apbd_pembiayaan_new'); ?>" class="btn btn-primary font-weight-bolder mt-2 mt-md-0">
            ...
            <tbody>
              ...
              foreach ($pembiayaan as $data) : ?>
                <tr>
                  ...
                  <td>
                    <div class="d-flex">
                      <a class="btn btn-sm btn-icon btn-clean" title="Ubah" href="<?= route_to('data_apbd_pembiayaan_edit', $data->id); ?>">
                        <i class="far fa-edit fa-sm"></i>
                      </a>
                      <form action="<?= route_to('data_apbd_pembiayaan_delete', $data->id); ?>" method="post" class="d-inline">
