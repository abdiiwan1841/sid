    ...
    <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-2">
                <!--begin::Page Title-->
                <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Dashboard - Admin</h5>
                <!--end::Page Title-->
            </div>
            <!--end::Info-->
        </div>
                ...
                <div class="col-xl-3">
                    ...
                    <div class="card card-custom bg-success card-stretch gutter-b">
                        ...
                        <div class="card-body">
                            ...
                            <span class="font-weight-bold text-white font-size-sm">All User</span>
                        </div>
                        <!--end::Body-->
                    </div>
                    <!--end::Stats Widget 26-->
                ...
                <div class="col-xl-3">
                    ...
                    <div class="card card-custom bg-warning card-stretch gutter-b">
                        ...
                        <div class="card-body">
                            ...
                            <span class="font-weight-bold text-white font-size-sm">Supervisor</span>
                        </div>
                        <!--end::Body-->
                    </div>
                    <!--end::Stats Widget 27-->
                ...
                <div class="col-xl-3">
                    ...
                    <div class="card card-custom bg-info card-stretch gutter-b">
                        ...
                        <div class="card-body">
                            ...
                            <span class="font-weight-bold text-white font-size-sm">Operator</span>
                        </div>
                        <!--end::Body-->
                    </div>
                    <!--end::Stat: Widget 28-->
                ...
                <div class="col-xl-3">
                    ...
                    <div class="card card-custom bg-success card-stretch gutter-b">
                        ...
                        <div class="card-body">
                            ...
                            <span class="font-weight-bold text-white font-size-sm">Jumlah Keluarga</span>
                        </div>
                        <!--end::Body-->
                    </div>
                    <!--end::Stats Widget 25-->
                ...
                <div class="col-xl-3">
                    ...
                    <div class="card card-custom bg-primary card-stretch gutter-b">
                        ...
                        <div class="card-body">
                            ...
                            <span class="font-weight-bold text-white font-size-sm">Jumlah Penduduk</span>
                        </div>
                        <!--end::Body-->
                    </div>
                    <!--end::Stats Widget 30-->
